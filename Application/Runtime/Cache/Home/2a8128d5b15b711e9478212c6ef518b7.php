...
<body>
<script type="text/javascript" src="<?php echo C('_HOME_JS_');?>/userRegister.js"></script>
<form method="post" id="user_register_form">
    <div>手机：<input type="text" name="mobile" id="user_register_mobile" /></div>
    <div>密码：<input type="password" name="password" /></div>
    <div>验证码：<input type="text" name="verify" /></div>
    <div><img src="/Home/User/showVerify" title="点击更换" onclick="user_register_update_verify(this)" /></div>
    <div><button type="button" onclick="user_register_form_submit()">提交</button></div>
</form>
</body>
</html>