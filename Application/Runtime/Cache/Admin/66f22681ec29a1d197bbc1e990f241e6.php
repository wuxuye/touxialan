...
<div class="admin_box edit_goods_box">
    <form method="post" enctype="multipart/form-data" >
        ...
        商品扩展名：<input type="text" name="goods_ext" value="<?php echo ($info["goods_ext_name"]); ?>" /><br>
        所属分类：<span id="attr_list"></span><br>
        <input type="hidden" id="attr_parent_id" name="goods_attr_id" value="<?php echo ($info["goods_attr_id"]); ?>" />
        商品单价：<input type="text" name="goods_price" value="<?php echo ($info["goods_price"]); ?>" /><br>
        商品描述：<textarea name="goods_describe"><?php echo ($info["goods_describe"]); ?></textarea><br>
        商品所属：<input type="text" name="goods_belong" value="<?php echo ($info["goods_belong_id"]); ?>" /><br>
